...
import { LogOut, Bell, Menu, X, Home, Users, Settings, BarChart3, Package, Truck, Wrench, FileText, Shield, Database, Wifi, WifiOff } from 'lucide-react';
import { useState, useEffect } from 'react';
import DatabaseConnectionTest from './DatabaseConnectionTest';

const DashboardLayout = ({ children, title, subtitle }) => {
  const { user, logout, useDatabase, connectionStatus } = useAuth();
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4 animate-slide-in-right">
              ...
              <div className="hidden md:flex items-center space-x-2">
                <DatabaseConnectionTest compact={true} />
              </div>
